...
class PersonParser {
  ...
  bacaFile() {
    let peopleList = fs.readFileSync(this._file, 'utf-8').split('\n')
    let peopleArr = []
  ...
  //   for(let i = 1; i < this._arr.length; i++){
      // this._obj.push(new Person(this._arr[i][0],this._arr[i][1],this._arr[i][2],this._arr[i][3],this._arr[i][4],this._arr[i][5],this._arr[i][6]))
  //   }
  // }
...
//
// let baca = fs.readFileSync('people.csv', 'utf-8')
// console.log(baca);
